...
<div class="card" style="padding:0">
    <table>
        <thead><tr><th>Event type</th><th>Provider</th><th>Provider event ID</th><th>Status</th><th>Processed</th><th>Received</th></tr></thead>
        <tbody>
            @forelse($events as $e)
            <tr>
            ...
            @empty
            <tr><td colspan="6" class="text-dim" style="text-align:center;padding:2rem">No billing events recorded yet.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
